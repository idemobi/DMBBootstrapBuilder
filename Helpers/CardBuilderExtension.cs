...
// DMBBootstrapBuilder.csproj CardBuilderExtension.cs create at 2026/04/08 09:04:40
...
namespace DMBBootstrapBuilder
{
    ...
    /// </summary>
    public static class CardBuilderExtension
    {
        ...
        public static CardBuilder SetLocalizedIconBootstrap(this CardBuilder builder, string iconBootstrapKey)
        {
            #if DEBUG
        ...
        /// <returns>The configured <see cref="CardBuilder"/> value or BootstrapBuilder result.</returns>
        public static CardBuilder SetLocalizedTitle(this CardBuilder builder, string titleKey, params object[] args)
        {
            #if DEBUG

...
namespace DMBBootstrapBuilderLabs
{
    /// <summary>
    ///     Provides HTML helper extensions for rendering demo partials with preview and source-code panels.
    /// </summary>
    public static class DemoHtmlHelperExtensions
    {
        ...
        /// <summary>
        ///     Renders an example partial with a preview panel and a matching raw-code panel.
        /// </summary>
        /// <param name="htmlHelper">The current Razor HTML helper.</param>
        /// <param name="partialViewName">The example partial view name, relative to the examples folder.</param>
        /// <param name="title">The title displayed in the example header.</param>
        /// <param name="icon">The icon displayed in the example header.</param>

# AI Rules - DMBBootstrapBuilder

## Scope

- Applies to `DMBBootstrapBuilder` folder and descendants.
...
- Provide Bootstrap-oriented visual builders for the PageBuilder ecosystem.
- Keep component APIs, rendered Bootstrap markup, Razor helpers, action items, layout builders, and page chrome behavior stable for consumers across the ecosystem.
...
- Keep component, layout, and Bootstrap class generation behavior deterministic and predictable.

# DMBBootstrapBuilder Draw.io Diagram Rules
...
- Default area folder for this project: `BootstrapBuilder`
...
```html
<img src="/drawio/BootstrapBuilder/rendering-pipeline.drawio.svg" alt="BootstrapBuilder rendering pipeline diagram" />
```

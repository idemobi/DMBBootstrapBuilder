# DMBBootstrapBuilder Examples and Tutorials Rules

## Objective

Define how example pages, demo pages, and tutorials are created for `DMBBootstrapBuilder` and related PageBuilder ecosystem packages.
